...
public class Thiss {
    ...
    static public String generateNewName() {
        ...
        while (res.equals(s1) || res.equals(s2) || res.equals(s3)) {
            res = generateName();
        }
        s1 = s2;
        s2 = s3;
    ...
    static public Text saySth(Entity entity, String sth) {
        return new LiteralText('<' + Objects.requireNonNull(entity.getCustomName()).asString()
                + "> " + sth);
    }
